...
class Raycaster {
  ...
  late Vector2 plane; // = Vector2(0, 0.66);
  ...
  // Wall draw buffers
  late Float32List _sliverTransforms;
  late Float32List _sliverRects;
  late Int32List _sliverColors;
  ...
  void _raycast(int x) {
    ...
    late int hit = 0, // was there a wall hit?
